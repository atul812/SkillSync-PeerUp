  ...
  return (
    <div className="container mx-auto py-8 space-y-6">
      <div className="text-center">
        ...
        <h1 className="text-4xl font-bold">SkillSwap Champions</h1>
          ...
          <Table>
            ...
            <TableBody>
              {leaderboardData.map((entry) => (
                <TableRow key={entry.userId} className={entry.userId === "user123" ? "bg-primary/10" : ""}>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-medium">{entry.name} {entry.userId === "user123" && "(You)"}</span>
                    </div>
                  </TableCell>
